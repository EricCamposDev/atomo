...
<html lang="en">
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target=".ba-manager"><b>Base Application<br><i class="fas fa-cogs"></i> Gerenciar</b></button>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="folder" value="<?=$db->dbhost; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend" style="width: 30%;">
                                            <span class="input-group-text" id="basic-addon1"><b>Banco</b></span>
                                        </div>
                                        <input type="text" name="folder" value="<?=$db->dbname; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend" style="width: 30%;">
                                            <span class="input-group-text" id="basic-addon1"><b>Usuário</b></span>
                                        </div>
                                        <input type="text" name="folder" value="<?=$db->dbuser; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend" style="width: 30%;">
                                            <span class="input-group-text" id="basic-addon1"><b>Senha</b></span>
                                        </div>
                                        <input type="text" name="folder" value="<?=$db->dbpass; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="folder" value="<?=$config->login_access_name; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                    ...
                                    <?php if($modules): ?>
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control df-module" name="">
                                            </select>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="folder" value="<?=$config->login_access_view; ?>" class="form-control" placeholder="Username" />
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if($modules): ?>
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control df-module" name="default_module">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("button[data-target=.ba-manager]").click(function(){
                getBaseApps()
            })
        })
    </script>
